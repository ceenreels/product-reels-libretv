(function (root) {
  ...
  function getEligibleSources(opts) {
    ...
    ids = ids.filter(function(id,i){ var s=info(id,map[id],i); return s.enabled && s.defaultEligible && isSourceHealthy(id, opts.now) && s.capabilities.search !== false && langMatch(s,opts.locale) && regionMatch(s, opts.region); });
